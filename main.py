...
def main():
    ...
    st.sidebar.info("This is a chatbot powered by OpenAI's GPT-3 model. It is designed to provide information on regulatory affairs, quality assurance, and product development. Please use it responsibly.")
    ...
    def interact_with_assistant(prompt):
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are a Regulatory Affairs Specialist."},
